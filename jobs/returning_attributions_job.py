...
class ReturningAttributionsJob(EtlJobV3):

		def __init__(self, target_date = None, db_connector = None, api_connector = None, file_location = ''):
			super().__init__(jobname = __name__, target_date = target_date, db_connector = db_connector, table_name = 'returning_attributions')
		...
		def get_conversions(self):
			...
			results = self.db_connector.read_redshift(f"""SELECT
												...
												WHERE sub.subscription_event_type = 'Returning Paid' 
		...
		def execute(self):
			self.loggerv3.info("Running Returning Attributions")

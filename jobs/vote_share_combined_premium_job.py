...
class VoteShareCombinedPremiumJob(EtlJobV3):

	def __init__(self, target_date = None, db_connector = None, api_connector = None, file_location = ''):
		super().__init__(jobname = __name__, target_date = target_date, db_connector = db_connector, table_name = 'vote_share_combined_premium')
	...
	def execute(self):
		self.loggerv3.info(f"Running Vote Share Combined Premium for {self.target_date}")
		self.load_data()

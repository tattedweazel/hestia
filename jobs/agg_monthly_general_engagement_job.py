...
class AggMonthlyGeneralEngagementJob(EtlJobV3):

	def __init__(self, target_date = None, db_connector = None, api_connector = None, file_location = ''):
		super().__init__(jobname=__name__, target_date = target_date, db_connector = db_connector, table_name = 'agg_monthly_general_engagement')
	...
	def execute(self):
		self.loggerv3.start(f"Running Monthly General Engagement for {self.formatted_dates['start']}")
		self.process()
